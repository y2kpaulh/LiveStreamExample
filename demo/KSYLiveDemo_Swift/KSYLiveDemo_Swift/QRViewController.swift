...
class QRViewController: UIViewController {
   ...
   @discardableResult func startReading() -> Bool {
        ...
        guard let _captureSession = captureSession else { return false }
        // 3.创建媒体数据输出流
        ...
        // 6.实例化预览图层
        videoPreviewLayer = AVCaptureVideoPreviewLayer.init(session: _captureSession)
        // 7.设置预览图层填充方式
